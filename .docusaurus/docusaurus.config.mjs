...
export default {
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "/Users/elliottgodwin/Desktop/builders-docs/sidebars.ts",
          "routeBasePath": "/"
        },
        "theme": {
          "customCss": "/Users/elliottgodwin/Desktop/builders-docs/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      "style": "dark",
      "links": [],
      "copyright": "© 2025 Builders International"
    },
    "prism": {
      "theme": {
        "plain": {
